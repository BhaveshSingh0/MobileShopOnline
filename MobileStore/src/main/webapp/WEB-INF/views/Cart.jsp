			...
			<c:when test="${not empty cartLines}">
				...
				<table id="cart" class="table table-hover table-condensed">
						...
						<c:forEach items="${cartLines}" var="cartLine">
							<tr>
								<td data-th="Product">
									<div class="row">
										<div class="col-sm-2 hidden-xs">
											<img
												src="${context}/res/img/${cartLine.product.imagePath}.jpg"
								...
								<td class="actions" data-th="">
									...
									</button> <a href="${context	}/cart/${cartLine.id}/delete"
					...
					<tfoot>
						...
						<tr>
							<td><a href="${context}/index" class="btn btn-warning"><span
									class="glyphicon glyphicon-chevron-left"></span> Continue
									Shopping</a></td>
							<td colspan="2" class="hidden-xs"></td>
							<td class="hidden-xs text-center"><strong>Total
									&#8377; ${userModel.cart.grandTotal}</strong></td>
							<td><a href="${context}/cart/billingAddress" class="btn btn-success btn-block">Checkout
